...
mixin _$Request {
  ...
  int get workCategoryIdx => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      workerIdx: null == workerIdx
          ...
          : workerIdx // ignore: cast_nullable_to_non_nullable
              as int,
      workCategoryIdx: null == workCategoryIdx
          ? _value.workCategoryIdx
          : workCategoryIdx // ignore: cast_nullable_to_non_nullable
              as int,
      title: null == title
          ? _value.title
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.workCategoryIdx, workCategoryIdx) ||
                other.workCategoryIdx == workCategoryIdx) &&
...
abstract class _Request implements Request {
  factory _Request(
      ...
      required final int requesterIdx,
      required final int workerIdx,
      required final int workCategoryIdx,
